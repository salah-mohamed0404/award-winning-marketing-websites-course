...
export function HeroSection() {
  ...
  useGSAP(
    () => {
      // Reduced-motion / low-power: simple opacity fade, skip SplitText and DrawSVG
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* DrawSVG corner brackets — viewfinder materialise effect */}
        <svg
      ...
      {/* Title */}
      {/*
        Fix: gradient text is applied via .hero-line-2 .char CSS rule in styles.css.
        SplitText wraps chars in child spans which inherit -webkit-text-fill-color:transparent
        from the parent but lose the background gradient — applying per-char resolves this.
        overflow-hidden clips the yPercent:120 entrance animation so chars slide up into view.
        padding-bottom gives descenders room and prevents clipping at the baseline.
      */}
      ...
      <div
        ...
        style={{
          ...
          height: 1,
          background:
            'linear-gradient(90deg, transparent, var(--lagoon), var(--palm), transparent)',
          opacity: 0.4,
        }}
      />
