...
export const Route = createFileRoute('/2-css-version')({ component: CssVersion })

function CssVersion() {
  return (
    <div className="bg-blue-300 text-black" style={{ fontFamily: "'Antonio Variable', sans-serif" }}>
